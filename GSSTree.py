...
def exact_gss_tree(tree_A, tree_B):
    ...
    trace_ab = exact_trace(anc_A, anc_B, M_ab_preorder) + \
        exact_trace(sib_A, sib_B, M_ab_bfs)
    trace_aa = exact_trace(anc_A, anc_A, M_aa_preorder) + \
        exact_trace(sib_A, sib_A, M_aa_bfs)
    trace_bb = exact_trace(anc_B, anc_B, M_bb_preorder) + \
        exact_trace(sib_B, sib_B, M_bb_bfs)
